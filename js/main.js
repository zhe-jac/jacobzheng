...
const conversations = [
    ...
    },
    {
        ...
        messages: [
            ...
            { from: 'them', html: `<div class="skill-bubble"><strong>Languages</strong>Python · JavaScript · TypeScript · HTML &amp; CSS · SQL</div>`, time: '10:01 AM' },
            { from: 'them', html: `<div class="skill-bubble"><strong>Frameworks &amp; Libraries</strong>React · Node.js · Express · Tailwind CSS · NumPy / Pandas</div>`, time: '10:01 AM' },
            { from: 'them', html: `<div class="skill-bubble"><strong>Tools &amp; Platforms</strong>Git &amp; GitHub · VS Code · Docker · Linux · Figma</div>`, time: '10:02 AM' },
        ],
    },
    {
        id: 'projects',
...
function renderChat(conv) {
  ...
  `;
    ...
    const msgInput = inputArea.querySelector('#msg-input');
...
function appendMessage(thread, from, text, html, conv) {
    const row = document.createElement('div');
    ...
    if (from === 'me' && conv.id === 'contact') {
        setTimeout(() => {
            appendMessage(thread, 'them', "Thanks for reaching out! 🙌 I'll get back to you soon. You can also email me directly at your.email@example.com", null, conv);
        }, 1200);
    }
}
